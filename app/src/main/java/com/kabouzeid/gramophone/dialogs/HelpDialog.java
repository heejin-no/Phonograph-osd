...
public class HelpDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                ...
                .showListener(dialog1 -> {
                    if (getActivity() != null)
                        setHelpRead(getActivity());
                })
                .build();

        final WebView webView = customView.findViewById(R.id.web_view);
        try {
            // Load from phonograph-help.html in the assets folder
            StringBuilder buf = new StringBuilder();
            InputStream json = getActivity().getAssets().open("phonograph-help.html");
            ...
            final String help = buf.toString()
            ...
            webView.loadData(help, "text/html", "UTF-8");
        } catch (Throwable e) {
    ...
    public static void setHelpRead(@Nullable Context context){
